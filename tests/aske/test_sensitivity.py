...
# print(sensitivity_obj.__dict__)

# print(sensitivity_obj.check_first_order())
# print(sensitivity_obj.check_second_order())
# print(sensitivity_obj.check_total_order())


# print(sensitivity_obj.get_min_S2())
# print(sensitivity_obj.get_max_S2())

# sensitivity_obj.to_csv('test.csv', Si_dict)
# sensitivity_obj.to_json('test.json', Si_dict)
# sensitivity_obj.to_pickle('test_pickle', Si_dict)


# print(sensitivity_obj.from_csv('test.csv').__dict__)
# print(sensitivity_obj.from_json('test.json').__dict__)
# print(sensitivity_obj.from_pickle('test_pickle').__dict__)
...
# sobol_dict, sample_time_sobol, exec_time_sobol, analyze_time_sobol =
# sensitivity_analysis.Si_from_Sobol(N, ) 

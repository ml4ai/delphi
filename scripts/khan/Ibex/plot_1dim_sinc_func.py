...
def plot(filename):
    ...
    var1_ub[var1_ub == inf] = 10
    var1_lb[var1_lb == -inf] = -10
    ...
    for i in range(len(var1_ub)):
        ...
        ax.scatter(var1_lb[i], y=0, color = 'r', linestyle='-')
...
# filename = '/Users/souratoshkhan/delphi/scripts/khan/Ibex/intervals_sinc_func.txt'
# plot(filename)

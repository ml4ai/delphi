...
def SIR_Gillespie_SD__gillespie__loop_2__decision__n_I__1(n_I_0, n_I_1, IF_1):
    return n_I_1 if IF_1 else n_I_0


def SIR_Gillespie_SD__gillespie__loop_2__assign__n_I__2(n_I):
    return n_I - 1
...
def SIR_Gillespie_SD__gillespie__loop_2__decision__n_I__3(n_I_0, n_I_1, IF_1):
    return n_I_1 if IF_1 else n_I_0

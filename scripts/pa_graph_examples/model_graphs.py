...
if __name__ == "__main__":
    asce = nx_graph_from_dotfile(str(data_dir/"program_analysis"/"asce-graph.dot"))
    priestley_taylor = nx_graph_from_dotfile(str(data_dir/"program_analysis"/"priestley-taylor-graph.dot"))

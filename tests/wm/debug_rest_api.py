...
def check_model_status_loop(client, model_id, num_repeats):
...
def test_createModel_and_createExperiment(client):
    # Test create Model
    # model_id1 = create_model(client, "tests/data/delphi/create_model_7_nodes.json", 1)
    model_id1 = create_model(client, "tests/wm/scripts/3nodes_model.json", 1)

    check_model_status_loop(client, model_id1, 5)

    # Test create Experiment
    # rv = create_experiment(client, "tests/wm/scripts/3nodes_projection.json", model_id1, 1)

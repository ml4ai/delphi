...
********************************************************************************
C     Input Variables:
C     means     array of mean measures for a population
C     vars      array of variance measures for a population
C     k         current sample index for simulation
C     n         current count of population
C     runs      current run number
C
C     Updated Variables:
C     means     new mean measure placed at index k
C     vars      new variance measure placed at index k
********************************************************************************
...
!     Solver outputs
      ...
      call solver(S, I, R, gamma, rho, MeanS, MeanI, MeanR, VarS, VarI, VarR)
      end program main

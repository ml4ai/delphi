...
# G.clear()
values = {
    "petpt::msalb_0": np.random.rand(10000000),
    "petpt::srad_0": np.random.randint(1, 100, size=10000000),
    "petpt::tmax_0": np.random.randint(30, 40, size=10000000),
    "petpt::tmin_0": np.random.randint(10, 15, size=10000000),
    "petpt::xhlai_0": np.random.rand(10000000)
}
result = G.run(values)

...
for filename in filenames:
    ...
    for col in df.columns[1:-1]:
        ...
        if filename == directoryPath + 'ETH_gambela_maize_meher_historical_all.csv':
...
dict_var = {'HWAMA': 'Average Harvested Weight at Maturity (Maize)', 'TAVGA' : 'Average Temperature for Maize Production', 'PRCPA': 'Average Precipitation for Maize Production'}

...
def SIR_Gillespie_SD_inline__gillespie__assign__beta__0():
    return (rho*gamma)

def SIR_Gillespie_SD_inline__gillespie__assign__means__0():
    return [0] * (tmax - 0)

def SIR_Gillespie_SD_inline__gillespie__assign__meani__0():
    return [0] * (tmax - 0)

def SIR_Gillespie_SD_inline__gillespie__assign__meanr__0():
    return [0] * (tmax - 0)

def SIR_Gillespie_SD_inline__gillespie__assign__vars__0():
    return [0] * (tmax - 0)

def SIR_Gillespie_SD_inline__gillespie__assign__vari__0():
    return [0] * (tmax - 0)

def SIR_Gillespie_SD_inline__gillespie__assign__varr__0():
    return [0] * (tmax - 0)

def SIR_Gillespie_SD_inline__gillespie__assign__samples__0():
    return [0] * (tmax - 0)

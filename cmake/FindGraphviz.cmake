# * Try to find Graphviz Once done this will define
#
# GRAPHVIZ_FOUND - system has Graphviz GRAPHVIZ_INCLUDE_DIRS - Graphviz include
# directories GRAPHVIZ_CDT_LIBRARY - Graphviz CDT library GRAPHVIZ_GVC_LIBRARY -
# Graphviz GVC library GRAPHVIZ_CGRAPH_LIBRARY - Graphviz CGRAPH library
# GRAPHVIZ_PATHPLAN_LIBRARY - Graphviz PATHPLAN library GRAPHVIZ_VERSION -
# Graphviz version
#
# This module reads hints about search locations from the following cmake
# variables: GRAPHVIZ_ROOT          - Graphviz installation prefix (containing
# bin/, include/, etc.)

# Copyright (c) 2009, Adrien Bustany, <madcat@mymadcat.com> Copyright (c)
# 2013-2014 Kevin Funk <kevin.funk@kdab.com>

# Version computation and some cleanups by Allen Winter <allen.winter@kdab.com>
# Copyright (c) 2012-2014 Klarälvdalens Datakonsult AB, a KDAB Group company
# <info@kdab.com>

# Simplified script by Dogan Can <dogancan@usc.edu> Copyright (c) 2014
# University of Southern California

# Redistribution and use is allowed according to the terms of the GPLv3+
# license.
...
find_library(GRAPHVIZ_CDT_LIBRARY NAMES cdt HINTS ${_GRAPHVIZ_LIBRARY_DIR})
find_library(GRAPHVIZ_GVC_LIBRARY NAMES gvc HINTS ${_GRAPHVIZ_LIBRARY_DIR})
...
if(GRAPHVIZ_FOUND)
  set(
    FIND_GRAPHVIZ_VERSION_SOURCE
    "#include <graphviz/graphviz_version.h>\n#include <stdio.h>\n int main()\n {\n printf(\"%s\",PACKAGE_VERSION);return 1;\n }\n"
    )
  set(FIND_GRAPHVIZ_VERSION_SOURCE_FILE
      ${CMAKE_BINARY_DIR}/CMakeTmp/FindGRAPHVIZ.cxx)
  file(WRITE "${FIND_GRAPHVIZ_VERSION_SOURCE_FILE}"
       "${FIND_GRAPHVIZ_VERSION_SOURCE}")
  ...
  if(COMPILE_RESULT AND RUN_RESULT EQUAL 1)
    ...
    message(
      FATAL_ERROR
        "Unable to compile or run the graphviz version detection program.")
  endif()
  ...
  if(NOT Graphviz_FIND_QUIETLY)
    ...
    message(
      STATUS
        "Graphviz libraries: ${GRAPHVIZ_CDT_LIBRARY} ${GRAPHVIZ_GVC_LIBRARY} ${GRAPHVIZ_CGRAPH_LIBRARY} ${GRAPHVIZ_PATHPLAN_LIBRARY}"
      )
  endif()
endif()

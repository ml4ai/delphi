...
while count < interval:
    ...
    tmax_lst.append(result[0].lb())
    tmin_lst.append(result[1].lb())
    xhlai_lst.append(result[2].lb())
    msalb_lst.append(result[3].lb())
    srad_lst.append(result[4].lb())
    tdew_lst.append(result[6].lb())

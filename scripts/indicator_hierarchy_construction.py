...
def clean_FAOSTAT_data(outputFile):
    ...
    'Environment_LivestockManure', 'Environment_LivestockPatterns',  'Environment_Pesticides', 'Environment_Temperature_change', 'Exchange_rate', 'Food_Aid_Shipments_WFP',  'FoodBalanceSheetsHistoric', 'FoodBalanceSheets', 'Food_Security_Data', 'FoodSupply_Crops',  'FoodSupply_LivestockFish', 'Forestry_E', 'Forestry_Trade_Flows', 'Indicators_from_Household_Surveys', 'Inputs_FertilizersArchive', 'Inputs_FertilizersNutrient', 'Inputs_FertilizersProduct', 'Inputs_LandUse', 'Inputs_Pesticides_Trade', 'Inputs_Pesticides_Use', 'Investment_CapitalStock', 'Investment_CountryInvestmentStatisticsProfile', 
    'Investment_CreditAgriculture', 'Investment_ForeignDirectInvestment', 'Investment_GovernmentExpenditure', 'Investment_MachineryArchive', 'Investment_Machinery', 'Macro-Statistics_Key_Indicators', 'Population_E', 'Price_Indices', 'PricesArchive', 'Prices_E_All_Data', 'Prices_Monthly', 'Production_CropsProcessed', 'Production_Crops', 'Production_Indices', 'Production_LivestockPrimary', 'Production_LivestockProcessed', 'Production_Livestock', 'Trade_Crops_Livestock', 'Trade_DetailedTradeMatrix', 'Trade_Indices', 'Trade_LiveAnimals', 'Value_of_Production' ]
    ...
    'Livestock Manure', 'Livestock Patterns', 'Pesticides indicators', 'Temperature change', 'Exchange rates - Annual', 'Food Aid Shipments (WFP)', 'Food Balances (old methodology and population)', 'New Food Balances', 'Suite of Food Security Indicators', 'Food Supply - Crops Primary Equivalent', 'Food Supply - Livestock and Fish Primary Equivalent', 'Forestry Production and Trade', 'Forestry Trade Flows', 'Indicators from Household Surveys (gender, area, socioeconomics)', 'Fertilizers archive', 'Fertilizers by Nutrient', 'Fertilizers by Product', 'Land Use', 'Pesticides Trade', 'Pesticides Use', 'Capital Stock', 'Country Investment Statistics Profile', 
    'Credit to Agriculture', 'Foreign Direct Investment (FDI)', 'Government Expenditure', 'Machinery Archive', 'Machinery', 'Macro Indicators', 'Annual population', 'Producer Price Indices - Annual', 'Producer Prices (old series)', 'Producer Prices', 'Producer Prices - Monthly',  'Crops processed', 'Crops', 'Production Indices', 'Livestock Primary', 'Livestock Processed', 'Live Animals', 'Crops and livestock products', 'Detailed trade matrix', 'Trade Indices', 'Live animals', 'Value of Agricultural Production']

...
# fig, axs = plt.subplots(nrows = 1, ncols = 5, sharex = True)
# ax = axs[0]
# ax.scatter(list(range(interval)), tmax_lst1, color = 'r', label = 'TMAX', s =
        # 50)
# ax.axvspan(0, interval, facecolor = 'yellow', alpha = 0.25)
# ax.legend()
# ax = axs[1]
# ax.scatter(list(range(interval)), tmin_lst1, color = 'b', label = 'TMIN', s =
        # 50)
# ax.legend()
# ax = axs[2]
# ax.scatter(list(range(interval)), msalb_lst1, color = 'g', label = 'MSALB', s =
        # 50)
# ax.legend()
# ax = axs[3]
# ax.scatter(list(range(interval)), xhlai_lst1, color = 'brown', label = 'XHLAI', s =
        # 50)
# ax.legend()
# ax = axs[4]
# ax.scatter(list(range(interval)), srad_lst1, color = 'black', label = 'SRAD', s =
        # 50)
# ax.legend()
# plt.show()
